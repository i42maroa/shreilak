...
export const CLEAR_WOOD_CELEBRATION:ResourceInterface = {
    id: "5",
    name:"OBJ.RENOVATION_SONGS.TITLE",
    description:"OBJ.RENOVATION_SONGS.DESCRIPTION",
    text:"OBJ.RENOVATION_SONGS.PROCESS",
    images:[
        {
            alt:"Elsa siging",
