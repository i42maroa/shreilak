    ...
    objectives:[
        {
            ...
            process: "Nada más llegar, decidió explorar la ciudad antes de ir a casa de su abuela. Sin embargo, París era un laberinto de calles y avenidas, muy diferente al bosque que solía recorrer. Con su teléfono en mano, Caperucita se conectó a las redes sociales para pedir recomendaciones sobre lugares que visitar y también para usar una aplicación de mapas que la guiara.",
            resources: [
            ]
        },
        {
            title:"El lobo en la red",
            process: "El Lobo, un experto en tecnología y redes sociales, había estado siguiendo a Caperucita desde que anunció su viaje a París. Con su habilidad para hackear cuentas y rastrear ubicaciones, el Lobo sabía exactamente dónde encontrarla en cada momento. A través de un perfil falso en redes sociales, se hizo pasar por un amable parisino dispuesto a mostrarle la ciudad.",
            resources: [
            ]
        },
        {
            title:"El peligro acecha",
            process: "Perdida en una ciudad desconocida y sin poder contactar a nadie, Caperucita se encontró en una situación precaria. El Lobo, ahora más agresivo, insistía en acompañarla a casa, pero Caperucita decidió confiar en su instinto y escapar.",
            resources: [
            ]
        },{
